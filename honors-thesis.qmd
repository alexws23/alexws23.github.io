...
The presence of these fruit-bearing trees acts as miniature oases, whether they are next to a busy highway or in a park. They provide vital food sources during the coldest parts of the year when the abundance of insects and other food sources is low.[^1] Without these planted fruit-bearing trees and shrubs, both native and introduced,[^2] the winter survivorship of robins, waxwings, and other fruit-eating birds and mammals might be much lower.\
\

[^1]: Kwit, C., Levey, D. J., Greenberg, C. H., Pearson, S. F., McCarty, J. P., & Sargent, S. (2004). Cold temperature increases winter fruit removal rate of a bird-dispersed shrub. Oecologia, 139(1), 30–34. <https://doi.org/10.1007/s00442-003-1470-6>

[^2]: Gleditsch, J. M., & Carlo, T. A. (2010). Fruit quantity of invasive shrubs predicts the abundance of common native avian frugivores in central Pennsylvania. Diversity and Distributions, 17(2), 244–253. <https://doi.org/10.1111/j.1472-4642.2010.00733.x>
...
[^3]: Atchison, K. A., & Rodewald, A. D. (2006). The Value of Urban Forests to Wintering Birds. Natural Areas Journal, 26(3), 280–288. <https://doi.org/10.3375/0885-8608(2006)26%5B280:tvouft%5D2.0.co;2>
...
This urban pond, despite its artificial appearance and its location in the middle of a busy city, nonetheless hosts an incredible diversity of life in the winter, especially in terms of waterfowl and other birds. This is true not just in this small city park, but others elsewhere in the country. Take Forest Park in the heart of St. Louis, Missouri, for instance. It’s a large urban park with a few artificial lakes, a golf course and some sports fields. This urban park, surrounded by businesses and homes, is known to host the majority of all waterfowl species found in the surrounding regions, providing valuable habitat in the middle of a sprawling city.[^4] These urban lakes provide valuable feeding and resting grounds for many species during a time of year when bodies of water are often frozen and inaccessible.\
\

[^4]: Wise, A., Rosener, A., Martin, A., Cote, M., Hopwood, C. D., Schwartz, E., Tharp, R., & Blake, S. (2024). A deep dive into the waterbird community of an urban oasis: implications for park management. Urban Ecosystems, 27(6), 2087–2099. <https://doi.org/10.1007/s11252-024-01576-4>

::: {style="text-align: left;"}
## Benefits and Threats of Urban Ecosystems
:::

I chose to share these stories and these places because they highlight some of the unique and important ways wildlife interacts with urban settings, and they are some moments that resonated strongly with me personally. However, these stories are only some of the ways that nature and urban places coexist. Leaf litter from neighborhood trees is used by many insect species to survive the winter.[^5] Small mammals, such as squirrels, run amok throughout residential areas and urban parks, feasting on whatever they can find. Bird feeders can provide stable food sources for numerous species, alleviating some of the difficulties of foraging in the winter.[^6] All of these and so much more are examples of how urban areas and biodiversity cannot just exist together but even benefit one another.\
\

[^5]: Ferlauto, M., & Burghardt, K. T. (2025). Removing autumn leaves in residential yards reduces the spring emergence of overwintering insects. Science of the Total Environment, 970, 178821. <https://doi.org/10.1016/j.scitotenv.2025.178821>

[^6]: Robb, G. N., McDonald, R. A., Chamberlain, D. E., & Bearhop, S. (2008). Food for thought: supplementary feeding as a driver of ecological change in avian populations. Frontiers in Ecology and the Environment, 6(9), 476–484. <https://doi.org/10.1890/060152>
...
However, urban landscapes not only provide value to ecosystems, but to human society as well. Interacting with and spending time in nature conveys numerous health benefits to people, from improving mental well-being[^7] to increasing attention span in children.[^8] Yet, every winter, I notice an unsurprising pattern; I encounter fewer people outside, especially when temperatures dip below freezing. Nowhere have I seen this more noticeably than at a local park I frequent. Here, there is an owl roost well known among members of the community. On a warm day, it’s not uncommon to see lots of people taking a moment away from their walk to admire these owls, sometimes drawn by the presence of birdwatchers or photographers On a cooler day, however, there are often far fewer people walking along the trail and usually no one checking out the owl.\
\

[^7]: van den Berg, M., Wendel-Vos, W., van Poppel, M., Kemper, H., van Mechelen, W., & Maas, J. (2015). Health benefits of green spaces in the living environment: A systematic review of epidemiological studies. Urban Forestry & Urban Greening, 14(4), 806–816. <https://doi.org/10.1016/j.ufug.2015.07.008>

[^8]: Moll, A., Collado, S., Staats, H., & Corraliza, J. A. (2022). Restorative effects of exposure to nature on children and adolescents: A systematic review. Journal of Environmental Psychology, 84, 101884. <https://doi.org/10.1016/j.jenvp.2022.101884>
...
This is not just a phenomenon here at this park and at this owl roost. In other parks elsewhere in the world, people tend to interact less with nature during the wintertime, with potential consequences for their health and well-being.[^9] Beyond that, fewer people interacting with nature means that less data is contributed to large citizen science projects, like iNaturalist[^10] or eBird,[^11] during the wintertime. Far less scientific research across numerous ecological disciplines is conducted during the winter, leaving broad gaps in our collective knowledge.[^12] This, especially in urban environments, poses a risk.\
\

[^9]: Jakstis, K., & Fischer, L. K. (2024). An observational assessment of winter human-nature interaction in urban parks. Basic and Applied Ecology, 79, 17–28. <https://doi.org/10.1016/j.baae.2024.05.001>

[^10]: Di Cecco, G. J., Barve, V., Belitz, M. W., Stucky, B. J., Guralnick, R. P., & Hurlbert, A. H. (2021). Observing the Observers: How Participants Contribute Data to iNaturalist and Implications for Biodiversity Science. BioScience, 71(11), 1179–1188. <https://doi.org/10.1093/biosci/biab093>

[^11]: Zhang, G. (2020). Spatial and Temporal Patterns in Volunteer Data Contribution Activities: A Case Study of eBird. ISPRS International Journal of Geo-Information, 9(10), 597. <https://doi.org/10.3390/ijgi9100597>

[^12]: Saana Sipari. (2023). Winter, the forgotten season. Global Change Biology, 30(1). <https://doi.org/10.1111/gcb.17085>
...
Notice the difference in greenery on either side of the South Platte River. To the right of the river, the neighborhoods are dominated by the dark green hues of abundant street trees and a large urban park dominates the center of the neighborhood. On the left side of the river, however, gray and brown hues overpower other colors, with far fewer street trees present throughout. Unsurprisingly, this divide falls largely across socio-economic lines.[^15] The greener neighborhood on the right is Washington Park, an affluent and predominantly white neighborhood. To the left however, these neighborhoods, including Ruby Hill and Athmar Park, are home to far more people of color and low-income households. This socio-economic divide and the resulting ecological difference have numerous effects, including differences in the access to the health benefits of interacting with nature and on the biodiversity of these neighborhoods.[^16] The greener and more affluent Washington park hosts a greater diversity of wildlife than the neighboring communities of Ruby Hill and Athmar Park, despite their proximity. Protecting urban ecosystems requires not just managing landscapes for wildlife and biodiversity but addressing systemic socio-economic issues that work against such goals.\
\

[^15]: Learn more about environmental justice in Colorado here: <https://cdphe.colorado.gov/enviroscreen>

[^16]: Leong, M., Dunn, R. R., & Trautwein, M. D. (2018). Biodiversity and socioeconomics in the city: a review of the luxury effect. Biology Letters, 14(5), 20180082. <https://doi.org/10.1098/rsbl.2018.0082>
